...
public final class WinAPIHelper {
    ...
    public static String getLastErrorStr(int errorCode) {
        ...
        int res = Kernel32.INSTANCE.FormatMessageW(Kernel32.FORMAT_MESSAGE_FROM_SYSTEM
        ...
        String result = mem.getPointer(0).getWideString(0);
    ...
    public static List<ProcessData> getProcesses() {
        System.out.println("Protected mode support: " + Native.isProtected());
        ...
        do {
            if (nxt != 0 && u32.IsWindowVisible(nxt)) {
                ...
                if (pd.WindowText.length() > 0) {
                    ...
                    System.out.println("getIconBits: " + pd.exeFile);
                    int size = 16;
                    ...
                    if (destroyIcon) {
                        System.out.println("DestroyIcon: " + pd.exeFile);
                        u32.DestroyIcon(hIconSm);
                    }
                    result.add(pd);
                }
            }
            System.out.println("getProcesses: DONE " + nxt);
            nxt = u32.GetWindow(nxt, User32.GW_HWNDNEXT);
        } while (nxt != 0);
        System.out.println("getProcesses: DONE");
        return result;
    }
